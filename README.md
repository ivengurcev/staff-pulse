...
FOUNDATION прошёл ручное ревью. Подтверждённого ручного переписывания сгенерированного кода на этом этапе нет; при появлении ручных правок их содержание и причины будут перечислены здесь.
